...
function parseInputs(): ActionInputs {
  const inputs: ActionInputs = {
    ...
    jiraBaseUrl: getOptionalInput('jira-base-url') || process.env.JIRA_BASE_URL,
    enableJiraLinks: getOptionalBooleanInput('enable-jira-links') || process.env.ENABLE_JIRA_LINKS === 'true',
  };
  return inputs;
}
